      ...
      <nav class="navbar navbar-expand-lg bg-primary">
        <div class="container-fluid">
          <a class="navbar-brand" href="#">
            <img src="https://i5.walmartimages.com/dfw/ecf648a-237c/k2-_6d66b486-7502-401d-939d-c9c1f6f22e11.v1.png" alt="" />
          </a>
          <div class="collapse navbar-collapse">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">

              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle toggle d-flex" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                  <div class="pt-1">
                    <img src="https://i5.walmartimages.com/dfw/4ff9c6c9-ad46/k2-_0a671c38-d307-447c-835e-7904ab143c26.v1.png" alt="" style="height: 34px;" />
                  </div>
                  <div class="mx-2">
                    <h6 class="d-inline text-white" style="letter-spacing: -0.74px; font-weight: 700;">¿Cómo quieres tus artículo?</h6>
                    <p class="text-white" style="font-size: 13px;">Sacramento, 95824• Sacramento Superce</p>
                  </div>
                </a>
                ...
                <ul class="dropdown-menu menu bg-primary">
                  ...
                  <div class="entrega bg-white w-100 p-3">
                    <div class="d-flex">
                      <i class="fa-solid fa-location-dot fa-sm pt-2" style="color: #000000;"></i>
                      <h6 class="mx-1 clash-war">Agrega una dirección de envío y entrega</h6>
                    </div>
                    <p class="contas-war">Sacramento, CA 95829</p>
                    <button class="btn w-100 text-white">Agregar Direction</button>
                  </div>

                  <div class="bg-white w-100 p-3 mt-2" style="height: 64px; border-radius: 7px;">
                    <div class="d-flex">
                      <i class="fa-solid fa-house fa-sm pt-2"></i>
                      <h6 class="mx-1 clash-war">Sacramento Supercenter</h6>
                    </div>
                    <p class="contas-war">8915 GERBER ROAD, Sacramento,</p>
                  </div>
                </ul>
              </li>
              ...
              <li class="nav-item">
                <div class="input-group mt-1 mb-3 d-none d-lg-flex">
                  <input type="text" class="custom-input" style="border-radius: 23px;" placeholder="Find Everything at Walmart Store" aria-label="Search" />
                  <span class="input-group-text my-2" style="border-radius: 50%; background-color: #002e99; margin-left: -7%; padding: .275rem .45rem;">
...
<div class="d-lg-none d-flex align-items-center justify-content-between px-3 py-2 bg-primary">
    <!-- Search bar -->
    <a class="navbar-brand" href="#">
      <img src="https://i5.walmartimages.com/dfw/ecf648a-237c/k2-_6d66b486-7502-401d-939d-c9c1f6f22e11.v1.png" alt="" />
    </a>
    <div class="input-group me-2">
    <input type="text" class="form-control w-50"  placeholder="Find  Walmart Store" style="border-radius: 23px;" />
    <span class="input-group-text bg-primary text-white" style="border-radius: 50%;">
      <i class="fas fa-search"></i>
    </span>
  </div>
  
  <!-- Offcanvas toggle button -->
  <button class="btn" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasResponsive" aria-controls="offcanvasResponsive">
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasResponsive" aria-labelledby="offcanvasResponsiveLabel">
  ...
  <div class="offcanvas-body">
    ...
    <div class="mb-3">
      <a style="color: #212529; font-weight:300"  href="#" class="d-flex align-items-center">
        <i class="fas fa-user me-2"></i> Sign In / My Account
      </a>
    </div>
    ...
    <div>
      <a style="color: #212529; font-weight:300"  href="#" class="d-flex align-items-center">
        <i class="fas fa-shopping-cart me-2"></i> Cart / Shop
      </a>
    </div>

    <div class="dropdown  mt-4 d-block align-items-center">
                       <h6 style="color: #212529; font-weight:300"  class="dropdown-toggle pt-2 pr-3 pb-3" data-bs-toggle="dropdown" style="font-weight: 700;">
                   ...
                   <div class="dropdown  mt-2  d-block align-items-center">
                       <h6 style="color: #212529; font-weight:300"  class="dropdown-toggle pt-2 pb-2" data-bs-toggle="dropdown" style="font-weight: 700;">
                           <i class="fa-regular fa-address-card fa-md" style="color: #5699e1;"></i>
                           service
                           <style>
                             .dropdown-toggle::after{
...
<div class="container-fluid d-block bg-primary d-lg-none">
  <div class="row">
    <div class="col-12">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu menu bg-primary w-100">
    ...
    <div class="container-fluid ">
        ...
        <div class="container-fluid section-class mb-3 d-md-flex">
            <div class="row">
                ...
                <div class="col-md-5 col-12  fix_up">
                    <div class="books">
                    ...
                    <div class=" row congress mt-3 mx-md-3">
                        ...
                        <div class="col-2 warnet">
                            <img class=" decor-offset" src="http://127.0.0.1:5500/public/imges/Walmart%20_%20Save%20Money.%20Live%20better._files/k2-_d5719461-3284-47b5-9b0d-4f3d37361b9c.v1.png"    alt="">
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-12 varcar">
                    <div class=" books">
...
<div class="container-fluid mx-lg-3 py-5">
    <div class="row">
        <div class="col-6  ml-lg-5">
            <div class="row">
                <div class="col-4  waracih align-items-center py-lg-4">
                    <img class="w-75 h-50 mt-lg-4" src="https://i5.walmartimages.com/asr/d2597a44-5123-42d8-a252-5cb8a9e60102.744c9356a10116cb282314b4c85a2f0c.jpeg?odnHeight=320&odnWidth=320&odnBg=FFFFFF" alt="Salted Coconut and Mahogany Scent">
                    <h6 class="mx-3 my-2" style="font-weight: 800;">$5.97</h6>
                    <p class="mx-3 security">Better Homes & Garden Salted Coconut and Mahogany Scent</p>
                    <button class="px-3 my-2 mx-3 option-btn">Option</button>
                </div>

                <div class="col-2 col-md-4 counter align-items-center py-lg-4 my-lg-3">
                    <img class="w-75 dta-candle" src="http://i5.walmartimages.com/seo/Great-Value-Taco-Shells-4-6-oz-12-Count_785b3fd3-fb19-469b-823b-21681d4a9e39.2c9a40123964aecbdce88596b2c86357.jpeg?odnHeight=350&odnWidth=350&odnBg=FFFFFF" alt="Taco Shells">
                    <h6 class="mx-3 mt-4" style="font-weight: 800;">$15.97</h6>
                    <p class="mx-3 security">Mainstays 3 Wick Textured Cranberry Mandarin Candle</p>
                    <button class="px-3 my-1 mx-3 option-btn">Option</button>
                </div>

                <div class="col-2 col-md-4 counter-less align-items-center py-lg-4 my-lg-3">
                    <img class="w-75 h-lg-100" src="https://i5.walmartimages.com/seo/Old-El-Paso-Taco-Seasoning-Mix-Original-Flavor-1-oz_a66ee4ca-72d1-490f-a4d6-26eede644ee8.374f8b723fba59f094ee1295eba870be.jpeg?odnHeight=350&odnWidth=350&odnBg=FFFFFF" alt="Taco Seasoning">
        ...
        <div class="col-5  position-relative">
            ...
            <img class="vently" src="https://i5.walmartimages.com/dfw/4ff9c6c9-ceed/k2-_31b24296-d552-4fa3-87a4-6281fda87a27.v1.jpg?odnHeight=894&odnWidth=1588&odnBg=&odnDynImageQuality=70" alt="Cinco de Mayo Celebration">
        </div>
    </div>
</div>
